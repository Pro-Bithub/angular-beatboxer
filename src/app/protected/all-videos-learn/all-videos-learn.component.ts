...
@Component({
  selector: "app-all-videos-learn",
  templateUrl: "./all-videos-learn.component.html",
  styleUrls: ["./all-videos-learn.component.css"],
})
export class allvideosLearnComponent implements OnInit {
