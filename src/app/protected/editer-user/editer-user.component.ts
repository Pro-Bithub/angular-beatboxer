...
@Component({
  selector: "editer-user",
  templateUrl: "./editer-user.component.html",
  styleUrls: ["./editer-user.component.css"],
})
export class EditerUserComponent implements OnInit {
  ...
  get_user_from_db_storage() {
    this.userObs$ = this.adminService.GetUserBYid(this.id);
    this.userObs$.subscribe(
      (rep) => {
        console.log("get_user_from_db_storage");
        console.log(rep);
