...
export class EventsComponent implements OnInit {
	...
	constructor(private adminService: AdminService, private formBuilder: FormBuilder, private titleService: Title) {
	...
	onSubmit() {
		...
		this.checksendeventObs$ = this.adminService.send_event_req(this.eventForm.value);
	}
	get f() {
